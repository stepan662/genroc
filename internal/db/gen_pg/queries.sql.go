...
func (q *Queries) GetChannel(ctx context.Context, arg GetChannelParams) (int32, error) {
...
func (q *Queries) GetDependencyVersion(ctx context.Context, arg GetDependencyVersionParams) (int32, error) {
